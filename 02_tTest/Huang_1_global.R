...
# THIS IS STUDY-SPECIFFIC
original_study_estimated_effect_size <- 0.68
...
#plot(metaEType1Realizations[[99]], type = 'l')
#lines(metaFType1Realizations[[99]], col="red")
...
# THIS IS STUDY-SPECIFFIC
#saveRDS(all_results, file = file.path("~", "projects", "manyLabsE","02_tTest","HuangData.rds"))
