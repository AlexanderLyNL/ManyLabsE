...
avgMetaResultsList <- avg_meta_results(PECDF, alpha, alphaRelevance, deltaMin, esMinFutility, varEqual, n_permutations = 5, meta_alpha = alpha/n_studies, meta_alphaRelevance = alphaRelevance/n_studies)
