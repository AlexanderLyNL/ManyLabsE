...
avgMetaResultsList <- avg_meta_results(PECDF, alpha, betaMinEffi, deltaMin, esMinFutility, varEqual, n_permutations = 5, meta_alpha = alpha/n_studies, meta_betaMinEffi = betaMinEffi/n_studies)
