...
ML2.df <- ML2.df %>%
  dplyr::select(2, 7, 103, 104, 105, 122, 123, 124, 521, 522, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532, 535, 536, 537) %>%
...
# Freq test ------
ML2.var[[g]] <- varfun.Kay.1(ML2.sr[[g]])
...
# save(dat, stat.params, file="kay.RData")
...
# save(res1, res2, res3, file="kay1Result.RData")
