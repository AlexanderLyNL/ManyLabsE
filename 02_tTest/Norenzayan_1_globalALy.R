...
freqRes <- t.test(variable ~ factor, data = ML2.var[[g]]$cleanDataFilter, var.equal = FALSE)
...
# save(dat, stat.params, file="norenzayan.RData")
...
# save(res1, res2, res3, file="norenzayan1Result.RData")


hist(res3$totalStoppingTimes)
