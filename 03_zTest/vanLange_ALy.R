...
res1a <- scenario1ZCorr(dat=dat, allSources=allSources, designObj=designObj, alpha=alpha, betaMinEffi=betaMinEffi,
...
# Scenario 2 ----
res2 <- metaScenario2(dat, allSources, designObj=designObj, seed=1, nSim = 5) # nSim=1e3)
