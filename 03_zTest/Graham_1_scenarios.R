...
if (substr(system("whoami", intern=TRUE), 1, 3) %in% c("are", "Are")) sourcePath <- "Bureau/futility"
if (substr(system("whoami", intern=TRUE), 1, 3) %in% c("ale", "Ale")) sourcePath <- "/Desktop/git/"

if (substr(system("whoami", intern=TRUE), 1, 3) %in% c("are", "Are")) myWd <-  "/home/areyerol/Bureau/futility/ManyLabsE/03_zTest" #"~/Desktop/git/manyLabsE/02_tTest/"
if (substr(system("whoami", intern=TRUE), 1, 3) %in% c("ale", "Ale")) myWd <-  "~/Desktop/git/manyLabsE/03_zTest/"
