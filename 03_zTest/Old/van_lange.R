...
mean(stops[is.finite(stops)])# 61.32
var(stops[is.finite(stops)])# 840.8057


mean(type == "futility")# 0.81 times we stopped for futility
mean(type == "reject")# 0.19
...
mean(stops[is.finite(stops)]) # 4356.69
var(stops[is.finite(stops)]) # 16980.94
