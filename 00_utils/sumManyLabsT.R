...
# res1$logMetaEMinEffi[which(is.infinite(res1$logMetaEMinEffi))] <- -1e27

round(mean(res1$logMetaEMinEffi), 3)
round(sd(res1$logMetaEMinEffi), 3)

# round(mean(res1$stopDecision==-1)*100, 3)

round(mean(res1$logMetaEMinEffi <= log(betaMinEffi))*100, 3)

round(mean(res1$eValues >= 1/alpha)*100, 3)
round(mean(res1$eValuesFut <= betaMinEffi)*100, 3)
...
round(mean(logMetaEFut <= log(betaMinEffi))*100, 3)
# round(sd(logMetaEFut <= log(betaMinEffi))*100, 3)
...
round(mean(res3$logMetaEFut <= log(betaMinEffi))*100, 3)
# round(sd(res3$logMetaEFut <= log(betaMinEffi))*100, 3)
...
round(mean(res1Plus$logMetaEFut <= log(betaMinEffi))*100, 3)
# round(mean(res1Plus$stopDecision==-1)*100, 3)


round(mean(res1Plus$eValues >= 1/alpha)*100, 3)
round(mean(res1Plus$eValuesFut <= betaMinEffi)*100, 3)
...
round(mean(res3Plus$logMetaEFut <= log(betaMinEffi))*100, 3)
# round(sd(res3Plus$logMetaEFut <= betaMinEffi)*100, 3)
