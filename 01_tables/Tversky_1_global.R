...
# ANALYSIS INFO ----
study.description      <- 'Framing (Tversky & Kahneman, 1981)'
analysis.unique.id     <- 46
analysis.name          <- 'Tversky.1'
analysis.type          <- 1
...
ML2.df <- ML2.df  %>%
  dplyr::select(2,7,296,301,805,904,905,906,907,908,909,910,911,912,913,914,915,938,939,940) %>%
...
# To see the function code type:varfun.Tversky.1, or lookup in manylabRs_SOURCE.R
ML2.var[[g]] <- varfun.Tversky.1(ML2.sr[[g]])
